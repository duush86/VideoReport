var BCLS = (function(window, document) {
  var account_id,
    ...
    client_secret,
    // api stuff
    proxyURL = 'doc-samples-proxy-v2.php',
    baseURL = 'https://cms.api.brightcove.com/v1/accounts/',
    timeframe = "2019-01-01..2019-11-15",
    limit = 100,
    totalVideos = 0,
    totalCalls = 0,
    callNumber = 0,
  ...
  function startCSVStrings() {
    var i = 0,
      iMax;
    csvStr = '"ID","Name","Reference ID","Description","Date Added","Date Last Modified","Filename","Video Master Size (MB)",\r\n';
  }
  ...
  function createRequest(id) {
    ...
    switch (id) {
      case 'getCount':
        ...
        endPoint += '&q=created_at:'+timeframe;
        //}
      ...
      case 'getDigitalMaster':
        console.log("Total of videos: "+videosArray.length)
        console.log("For videoID: "+videosArray[callNumber].id)
        console.log("Currently in call: "+callNumber)
        ...
        makeRequest(options, function(response) {
            ...
            if (isDefined(responseDecoded) && !isDefined(responseDecoded.length)) {
                console.log("response decoded"+responseDecoded)
                videosArray[callNumber].totalSize += responseDecoded.size;
                console.log("VideoID "+videosArray[callNumber].id+"Size: "+responseDecoded.size);
                videoMasterSize[callNumber] = responseDecoded.size;
                console.log(videoMasterSize);
